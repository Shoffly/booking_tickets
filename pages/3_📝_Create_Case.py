...
def load_dealers():
    try:
        ...
        # Query to get dealers (using same table structure as tgr.py)
        query = """
...
def load_car_names():
    try:
        ...
        # Query to get car names with details from live cars (using same structure as tgr.py)
        query = """
        with publishing AS (
        ...
        AND live_cars.live_status IS NOT NULL
